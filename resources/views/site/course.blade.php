            ...
            <div class="course-detail-grid">
                <div class="course-detail-content">
                    ...
                    <div class="course-content-grid">
                        <div class="course-content-stack">
                            @if ($course['overview'] !== '')
                            ...
                            {{-- Career Opportunities is temporarily hidden; keep this block for later restoration.
                        ...
                        <div class="course-poster-placeholder @if (! empty($course['poster_image_url'])) has-poster @endif">
                            @if (! empty($course['poster_image_url']))
                                <img src="{{ $course['poster_image_url'] }}" alt="{{ $course['title'] }} course poster" loading="lazy">
                            @else
                                <span>Course Poster Image</span>
                            @endif
                        </div>
